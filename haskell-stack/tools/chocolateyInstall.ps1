...
$url64 = 'https://github.com/commercialhaskell/stack/releases/download/v2.7.1/stack-2.7.1-windows-x86_64.zip'
$checksum64 = '12729150cbbd0e5007fc59a70ed17a9ba4ef1430e24d3e440b435128a3029ab1'
